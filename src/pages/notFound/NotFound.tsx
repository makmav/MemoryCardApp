...
export default function NotFount(): ReactElement {
    useEffect(() => {
        const path: HTMLElement|null = document.getElementById('tail');
        (path as HTMLElement).setAttribute('d','M89,315c2.2-15.2-23-13.2-21.6,4.8c1.7,22.3,24.4,22.1,42.5,9.1c10.8-7.8,15.3-1.8,19.1,1.1 c2.3,1.7,6.7,3.3,11-3');
    });
    return (
